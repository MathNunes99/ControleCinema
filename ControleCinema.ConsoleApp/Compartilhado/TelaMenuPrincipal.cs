...
namespace ControleCinema.ConsoleApp.Compartilhado
{
    public class TelaMenuPrincipal
    {
        ...
        public TelaMenuPrincipal(Notificador notificador)
        {
            ...
            telaCadastroSessao = new TelaCadastroSessao(repositorioSessao, notificador, telaCadastroFilme, telaCadastroSala, repositorioSala, repositorioFilme);
        }
        ...
        public string MostrarOpcoes()
        {
            ...
            Console.WriteLine("Digite 5 para Gerenciar Filme");
